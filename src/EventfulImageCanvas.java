...
public class EventfulImageCanvas extends ImageCanvas implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener
{
    public EventfulImageCanvas(int width, int height)
    {
        super(width, height);
        addKeyListener(this);
